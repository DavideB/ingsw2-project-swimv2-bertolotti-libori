...
public class HelprequestManager implements StatelessEJBHelprequest {
	...
	public boolean createHelprequest(int ans_id, Date ansdate,
			byte isForFriend, String message, int sen_id, Date sentdate,
			int skillId) {
	...
	@Override
	@TransactionAttribute
	public boolean createHelprequest(byte isForFriend, String message,
			int sen_id, Date sentdate, int skillId) {
		Helprequest Helprequest = new Helprequest();
		Helprequest.setIsForFriend(isForFriend);
		Helprequest.setMessage(message);
		Helprequest.setSen_id(sen_id);
	...
	public Helprequest getHelprequest(int hr_id) {
		Query q = em.createNamedQuery("Helprequest.findHelprequestById")
				.setParameter("id", hr_id);
	...
	public List<Helprequest> getUserHelprequests(int user_id) {
		ArrayList<Helprequest> toReturn = new ArrayList<Helprequest>();
		Query q = em.createNamedQuery("Helprequest.findHelprequestByUserId")
	...
	public List<Helprequest> getSkillHelprequests(int skill_id) {
		ArrayList<Helprequest> toReturn = new ArrayList<Helprequest>();
		Query q = em.createNamedQuery("Helprequest.findHelprequestBySkillId")
