...
/**
 * Servlet implementation class ManageNewSkillrequests
 */
public class ManageNewSkillrequests extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManageNewSkillrequests() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<Skill> availableskills = statelessBeanSkill.getAllSkills();
    	...
    	List<User> users = statelessBean.getAllUsers();
    	users.clear();
	    for (Newabilityrequest newabilityrequest : newabilityrequests) {
	    	users.add(statelessBean.getUser(newabilityrequest.getMak_id()));
	    	}
	    request.setAttribute("availableskills", availableskills);
	    request.setAttribute("newabilityrequests", newabilityrequests);
